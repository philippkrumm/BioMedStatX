...
class ExportDispatcher:
    ...
    def export_analysis_results(results, output_file, analysis_log=None) -> dict:
        ...
        ResultsExporter.export_results_to_excel(results, str(excel_path), analysis_log)
        ...
        try:
            ...
            html_result = HTMLExporter.export_results_to_html(results, str(html_path), analysis_log)
